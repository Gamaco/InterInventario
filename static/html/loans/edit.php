...
if ($id === false || $id === null) {
    ...
    $PTag = $loans["PTag"];
    $LOAN_TO = $loans["LOAN_TO"];
    $LOAN_TO_NAME = $loans["LOAN_TO_NAME"];
    $LOAN_TO_AFFILIATION = $loans["LOAN_TO_AFFILIATION"];
    $LOANER_AUTH = $loans["LOANER_AUTH"];
} else {
	...
	do {
		...
		$query = "CALL UpdatePrestamoByPTag(?, ?, ?, ?, ?, ?, ?)";
		...
		// Bind parameters
		$stmt->bind_param("sssssss", $LOAN_TO, $LOANER_AUTH, $START_DATE, $END_DATE, $Ptag, $NAME, $AFFILIATION);
								...
								<div class="row flex-wrap">
									<div class="col-12 col-md mb-3">
										<div data-mdb-input-init class="form-outline">
											...
											<div data-mdb-input-init class="form-outline">
												<input type="text" name="LOAN_TO" id="LOAN_TO" class="form-control fs-4 form-control-lg" placeholder="e.g. Y00561278" value="<?php echo $LOAN_TO ?>" required />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row flex-wrap">
									<div class="col-12 col-md mb-3">
										<div data-mdb-input-init class="form-outline">
											...
											<div data-mdb-input-init class="form-outline">
												<input type="text" name="LOAN_TO_NAME" id="LOAN_TO_NAME" class="form-control fs-4 form-control-lg" placeholder="e.g. John Doe" value="<?php echo $LOAN_TO_NAME ?>" required />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row flex-wrap">
									<div class="col-12 col-md mb-3">
										<div data-mdb-input-init class="form-outline">
											...
											<div data-mdb-input-init class="form-outline">
												<input type="text" name="LOANER_AUTH" id="LOANER_AUTH" class="form-control fs-4 form-control-lg" value="<?php echo $LOANER_AUTH; ?>" required />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row flex-wrap">
									<div class="col-12 col-md mb-3">
										<div data-mdb-input-init class="form-outline">
											...
											<div class="mb-3">
												<input type="date" name="START_DATE" id="START_DATE" class="form-control fs-4 form-control-lg" required>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row flex-wrap">
									<div class="col-12 col-md mb-3">
										<div data-mdb-input-init class="form-outline">
											...
											<div class="mb-3">
												<input type="date" name="END_DATE" id="END_DATE" class="form-control fs-4 form-control-lg" required>
											</div>
										</div>
									</div>
								</div>
