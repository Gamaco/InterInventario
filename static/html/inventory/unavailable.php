        ...
        <main class="content">
            ...
            <div class="row">
                <div class="btn-group mb-3 w-25">
                    <a href="./available.php" class="btn btn-lg btn-light" aria-current="page">Available</a>
                    <a href="./unavailable.php" class="btn btn-lg btn-warning">Unavailable</a>
                </div>
